...
<div class="container mx-auto px-4 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Недвижимость</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h1 class="text-4xl font-bold text-gray-800 dark:text-white mb-2 flex items-center">
                    ...
                    <span class="ml-3">Планы инвестиций в недвижимость</span>
                </h1>
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-4">Создавайте богатство через стратегические инвестиции в недвижимость с доказанной доходностью</p>
    ...
    <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-700 rounded-xl p-6 mb-8 border border-green-100 dark:border-gray-600">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="text-center">
                ...
                <div class="text-sm text-gray-600 dark:text-gray-300">Размер глобального рынка</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">8.2%</div>
                <div class="text-sm text-gray-600 dark:text-gray-300">Средний годовой рост</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-purple-600 dark:text-purple-400">15+</div>
                <div class="text-sm text-gray-600 dark:text-gray-300">Типы недвижимости</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-orange-600 dark:text-orange-400">50+</div>
                <div class="text-sm text-gray-600 dark:text-gray-300">Глобальные рынки</div>
            </div>
        </div>
    </div>
    ...
    <div x-data="{ selectedPlan: null }" class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 mb-12">
                ...
                <div class="relative h-48 bg-gradient-to-br from-green-400 via-emerald-500 to-teal-600 overflow-hidden">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="text-center text-white">
                            ...
                            <div class="text-sm font-medium opacity-90">Инвестиции в недвижимость</div>
                        </div>
                    </div>
                    <!-- Floating ROI -->
        ...
        @empty
            ...
            <div class="col-span-full flex flex-col items-center justify-center p-12 bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700">
                ...
                <h3 class="text-2xl font-bold text-gray-800 dark:text-white mb-2">Планы недвижимости недоступны</h3>
                <p class="text-gray-600 dark:text-gray-400 text-center max-w-md mb-6">
                    Инвестиционные планы недвижимости обновляются. Пожалуйста, проверьте позже для новых возможностей инвестиций в недвижимость.
                </p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 mb-8 border border-gray-100 dark:border-gray-700">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
            ...
            Почему выбрать инвестиции в недвижимость?
        </h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="flex space-x-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-xl">
                ...
                <div>
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-1">Стабильная доходность</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">Недвижимость обычно обеспечивает стабильную, предсказуемую доходность с меньшей волатильностью чем другие инвестиции.</p>
                </div>
            </div>
            ...
            <div class="flex space-x-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                ...
                <div>
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-1">Защита от инфляции</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">Стоимость недвижимости и доходы от аренды обычно растут с инфляцией, защищая вашу покупательную способность со временем.</p>
                </div>
            </div>
            ...
            <div class="flex space-x-4 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                ...
                <div>
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-1">Пассивный доход</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">Получайте регулярные доходы от аренды без активного управления, создавая надежный поток пассивного дохода.</p>
                </div>
            </div>
        </div>
        ...
        <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
            <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Как работают инвестиции в недвижимость</h4>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div class="text-center">
                    ...
                    <h5 class="font-semibold text-gray-900 dark:text-white mb-2">Выберите план</h5>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Выберите план инвестиций в недвижимость, который соответствует вашему бюджету и инвестиционным целям.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h5 class="font-semibold text-gray-900 dark:text-white mb-2">Инвестируйте средства</h5>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Безопасно инвестируйте свои средства в диверсифицированный портфель тщательно отобранной недвижимости.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h5 class="font-semibold text-gray-900 dark:text-white mb-2">Профессиональное управление</h5>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Наша команда экспертов управляет недвижимостью, работает с арендаторами и максимизирует доходность.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h5 class="font-semibold text-gray-900 dark:text-white mb-2">Получайте доходность</h5>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Получайте регулярную доходность от арендной платы и роста стоимости недвижимости прямо на ваш счет.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-xl p-8 mb-8 border border-gray-200 dark:border-gray-600">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">Наш портфель недвижимости</h3>
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            <div class="text-center">
                ...
                <div class="text-sm font-medium text-gray-700 dark:text-gray-300">Жилая</div>
            </div>
            ...
            <div class="text-center">
                ...
                <div class="text-sm font-medium text-gray-700 dark:text-gray-300">Коммерческая</div>
            </div>
            ...
            <div class="text-center">
                ...
                <div class="text-sm font-medium text-gray-700 dark:text-gray-300">Промышленная</div>
            </div>
            ...
            <div class="text-center">
                ...
                <div class="text-sm font-medium text-gray-700 dark:text-gray-300">Розничная</div>
            </div>
            ...
            <div class="text-center">
                ...
                <div class="text-sm font-medium text-gray-700 dark:text-gray-300">Смешанного назначения</div>
            </div>
            ...
            <div class="text-center">
                ...
                <div class="text-sm font-medium text-gray-700 dark:text-gray-300">REIT</div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center">
            ...
            Важная инвестиционная информация
        </h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-600 dark:text-gray-400">
            <div>
                <h4 class="font-semibold text-gray-800 dark:text-white mb-2">Факторы риска:</h4>
                <ul class="list-disc list-inside space-y-1">
                    <li>Стоимость недвижимости может колебаться в зависимости от рыночных условий</li>
                    <li>Инвестиции в недвижимость обычно менее ликвидны чем акции</li>
                    <li>Доходность может варьироваться в зависимости от результатов недвижимости и рыночных тенденций</li>
                    <li>Все инвестиции несут присущие им риски</li>
                </ul>
            </div>
            <div>
                <h4 class="font-semibold text-gray-800 dark:text-white mb-2">Преимущества инвестиций:</h4>
                <ul class="list-disc list-inside space-y-1">
                    <li>Включено профессиональное управление недвижимостью</li>
                    <li>Диверсифицированный портфель по нескольким типам недвижимости</li>
                    <li>Регулярные выплаты доходов</li>
                    <li>Потенциал долгосрочного накопления богатства</li>
                </ul>
            </div>
        </div>
    </div>
