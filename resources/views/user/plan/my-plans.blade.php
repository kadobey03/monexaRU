...
@section('title', 'Мои инвестиционные планы')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Мои инвестиции</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-2">Мои инвестиционные планы</h1>
                <p class="text-gray-600 dark:text-gray-300">Отслеживайте эффективность вашего инвестиционного портфеля</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 animate-fade-in stagger-item">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Всего инвестировано</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 animate-fade-in stagger-item">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Общая прибыль</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 animate-fade-in stagger-item">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Активные планы</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 animate-fade-in stagger-item">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Всего планов</p>
    ...
    <div class="space-y-6">
            ...
            <div class="p-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Инвестировано {{ $userPlan->created_at->format('d.m.Y') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 md:mt-0 text-right">
                        <div class="text-sm text-gray-500 dark:text-gray-400">Сумма инвестиций</div>
                ...
                <div class="mt-6">
                    ...
                    <div class="flex justify-between text-xs mt-2">
                        <span class="text-gray-500 dark:text-gray-400">Начато: {{ $userPlan->activated_at->format('d.m.Y') }}</span>
                        <span class="text-gray-500 dark:text-gray-400">Завершается: {{ $userPlan->expires_at->format('d.m.Y') }}</span>
                    </div>
                </div>
                @endif
                ...
                <div class="flex flex-col sm:flex-row justify-between mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex space-x-6">
                        <div>
                            <span class="text-sm text-gray-500 dark:text-gray-400">Текущая стоимость</span>
                        ...
                        <div>
                            <span class="text-sm text-gray-500 dark:text-gray-400">Прибыль</span>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
            ...
            <h3 class="text-xl font-medium text-gray-700 dark:text-gray-300 mb-2">Инвестиционные планы не найдены</h3>
            <p class="text-gray-500 dark:text-gray-400 mb-6">У вас еще нет {{ $status !== 'all' ? $status : '' }} инвестиционных планов.</p>
            <a href="{{ route('user.plans.index') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
                Обзор инвестиционных планов
            </a>
        </div>
        @endforelse
