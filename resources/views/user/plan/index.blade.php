...
@section('title', 'Инвестиционные Планы')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between animate-fade-in">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-300">Улучшите свой аккаунт с нашими высокодоходными инвестиционными возможностями</p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="p-6 {{ $plan->featured ? 'bg-gradient-to-r from-indigo-600 to-purple-600' : 'bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800' }}">
                    ...
                    <div class="{{ $plan->featured ? 'text-white' : 'text-gray-700 dark:text-gray-300' }}">
                        ...
                        <div class="flex items-center">
                            ...
                            <span>{{ $plan->payout_interval === 'daily' ? 'Ежедневные' : ($plan->payout_interval === 'weekly' ? 'Еженедельные' : ($plan->payout_interval === 'monthly' ? 'Ежемесячные' : ucfirst($plan->payout_interval))) }} выплаты</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-span-full p-8 text-center border rounded-xl bg-white dark:bg-gray-800">
            ...
            <h3 class="text-xl font-medium text-gray-700 dark:text-gray-300 mb-2">Нет Доступных Инвестиционных Планов</h3>
            <p class="text-gray-500 dark:text-gray-400">В данной категории пока нет доступных инвестиционных планов.</p>
        </div>
        @endforelse
    </div>
    ...
    <div class="mt-16">
        <div class="text-center mb-10">
            <h2 class="text-3xl font-bold text-gray-800 dark:text-white mb-2">Почему Стоит Выбрать Наши Инвестиционные Планы?</h2>
            <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Наши инвестиционные планы разработаны для обеспечения максимальной доходности при минимальном риске. Вот почему тысячи инвесторов доверяют нам.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">Безопасно и Надёжно</h3>
                <p class="text-gray-600 dark:text-gray-400">Ваши инвестиции защищены новейшими мерами безопасности. Мы приоритизируем безопасность ваших средств.</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">Высокая Доходность</h3>
                <p class="text-gray-600 dark:text-gray-400">Наши инвестиционные планы предлагают конкурентную доходность по сравнению с традиционными вариантами инвестирования, помогая вам быстрее приумножить богатство.</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">Быстрые Выплаты</h3>
                <p class="text-gray-600 dark:text-gray-400">Регулярные выплаты прямо на ваш счёт без задержек. Мы гарантируем, что вы получите свой доход вовремя, каждый раз.</p>
            </div>
        </div>
    </div>
</div>
