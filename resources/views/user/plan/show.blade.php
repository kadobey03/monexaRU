            ...
            <div>
                ...
                <div class="flex flex-wrap items-center gap-4 text-sm">
                    ...
                    <div class="inline-flex items-center px-3 py-1 bg-white/20 rounded-lg">
                        ...
                        <span>{{ $plan->duration }} {{ Str::plural('день', $plan->duration) }}</span>
                    </div>
                    <div class="inline-flex items-center px-3 py-1 bg-white/20 rounded-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <span>{{ ucfirst($plan->payout_interval) }} выплаты</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden animate-fade-in">
                <div class="p-6 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                    <h2 class="text-xl font-bold text-gray-800 dark:text-white">Детали инвестиционного плана</h2>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Диапазон инвестиций</h3>
                        ...
                        <div>
                            <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Диапазон ROI</h3>
                            <p class="text-lg font-semibold text-gray-900 dark:text-white">
                        ...
                        <div>
                            <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Длительность</h3>
                            <p class="text-lg font-semibold text-gray-900 dark:text-white">
                                {{ $plan->duration }} {{ Str::plural('день', $plan->duration) }}
                            </p>
                        </div>

                        <div>
                            <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Частота выплат</h3>
                            <p class="text-lg font-semibold text-gray-900 dark:text-white">
                        ...
                        <div>
                            <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Капитализация</h3>
                        ...
                        <div>
                            <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Бонус</h3>
                            <p class="text-lg font-semibold text-green-600 dark:text-green-500">
                                {{ $plan->bonus_percentage }}% с инвестиций
                            </p>
                        </div>
                        @endif
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden animate-fade-in animate-fade-in-delay-1">
                <div class="p-6 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                    <h2 class="text-xl font-bold text-gray-800 dark:text-white">Особенности плана</h2>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden animate-fade-in animate-fade-in-delay-2">
                <div class="p-6 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                    <h2 class="text-xl font-bold text-gray-800 dark:text-white">Примеры доходов</h2>
                </div>
                <div class="p-6">
                    <div class="overflow-x-auto">
                        <table class="min-w-full">
                            <thead>
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">ИНВЕСТИЦИИ</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">ОБЩИЙ ДОХОД</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">ЧИСТАЯ ПРИБЫЛЬ</th>
        ...
        <div class="lg:col-span-1 animate-fade-in animate-fade-in-delay-3">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden sticky top-24">
                <div class="p-6 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                    <h2 class="text-xl font-bold text-gray-800 dark:text-white">Инвестировать в этот план</h2>
                </div>
                <div class="p-6">
                    <form action="{{ route('user.plans.purchase') }}" method="POST" id="purchaseForm">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex justify-between mt-1 text-xs text-gray-500 dark:text-gray-400">
                                <span>Мин: {{ Auth::user()->currency }}{{ number_format($plan->min_price, 2) }}</span>
                                <span>Макс: {{ Auth::user()->currency }}{{ number_format($plan->max_price, 2) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg mb-6">
                            <div>
                                <span class="block text-sm font-medium text-gray-500 dark:text-gray-400">Ваш баланс</span>
