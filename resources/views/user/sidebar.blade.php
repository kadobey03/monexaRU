...
<div class="sidenav" id="sidenav-main">
    ...
    <div class="clearfix nav-application">
        <a href="{{ route('dashboard') }}"
            ...
            <span class="pt-2 btn-inner--icon d-block">Главная</span>
        </a>
        <a href="{{ route('deposits') }}"
            ...
            <span class="pt-2 btn-inner--icon d-block">Депозит</span>
        </a>
        @if ($mod['investment'] || $mod['cryptoswap'])
            <a href="{{ route('withdrawalsdeposits') }}"
                ...
                <span class="pt-2 btn-inner--icon d-block">Вывод</span>
            </a>
        @endif
        @if ($mod['investment'])
            <a href="{{ route('tradinghistory') }}"
                ...
                <span class="pt-2 btn-inner--icon d-block">История транзакций</span>
            </a>
        @endif
        <a href="{{ route('accounthistory') }}"
            ...
            <span class="pt-2 btn-inner--icon d-block">Транзакции</span>
        </a>
        <a href="{{ route('notifications') }}"
            ...
            <span class="pt-2 btn-inner--icon d-block">Уведомления</span>
        </a>
        @if ($mod['cryptoswap'])
            <a href="{{ route('assetbalance') }}"
                ...
                <span class="pt-2 btn-inner--icon d-block">Обмен криптовалют</span>
            </a>
        @endif
        @if ($moresettings->use_transfer)
            <a href="{{ route('transferview') }}"
                ...
                <span class="pt-2 btn-inner--icon d-block">Перевод средств</span>
            </a>
        @endif
        @if ($mod['subscription'])
            <a href="{{ route('subtrade') }}"
                ...
                <span class="pt-2 btn-inner--icon d-block">Управляемые счета</span>
            </a>
        @endif
        <a href="{{ route('profile') }}"
            ...
            <span class="pt-2 btn-inner--icon d-block">Профиль</span>
        </a>
        @if ($mod['investment'])
            <a href="{{ route('mplans') }}"
                ...
                <span class="pt-2 btn-inner--icon d-block">Торговые планы</span>
            </a>
            ...
            <a href="{{ route('myplans', 'All') }}"
                ...
                <span class="pt-2 btn-inner--icon d-block">Мои планы</span>
            </a>
            ...
            <a href="{{ route('demo.dashboard') }}"
                ...
                <span class="pt-2 btn-inner--icon d-block">Демо торговля</span>
            </a>
        @endif
        @if ($mod['membership'])
            <a href="{{ route('user.courses') }}"
                ...
                <span class="btn-inner--icon d-block"><i class="fas fa-graduation-cap fa-2x"></i></span>
                <span class="pt-2 btn-inner--icon d-block">Обучение</span>
            </a>
        @endif
        @if ($mod['signal'])
            <a href="{{ route('tsignals') }}"
                ...
                <span class="pt-2 btn-inner--icon d-block">Торговые сигналы</span>
            </a>
        @endif
        <a href="{{ route('referuser') }}"
            ...
            <span class="pt-2 btn-inner--icon d-block">Рефералы</span>
        </a>
    </div>
    <!-- Misc area -->
    <div class="card bg-gradient-warning">
        <div class="card-body">
            <h5 class="text-white">Нужна помощь!</h5>
            <p class="mb-4 text-white">
                Свяжитесь с нашим круглосуточным центром поддержки
            </p>
            <a href="{{ route('support') }}" class="btn btn-sm btn-block btn-white rounded-pill">Связаться с нами</a>
        </div>
    </div>
</div>
