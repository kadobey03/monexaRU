...
<div class="container mx-auto px-4 py-8">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Криптовалюта</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h1 class="text-4xl font-bold text-gray-800 dark:text-white mb-2 flex items-center">
                    ...
                    <span class="bg-gradient-to-r from-orange-500 to-yellow-500 bg-clip-text text-transparent">Планы инвестиций в криптовалюту</span>
                </h1>
                <p class="text-lg text-gray-600 dark:text-gray-300 mb-4">Воспользуйтесь революцией цифровых валют с высокодоходными криптоинвестициями</p>
            ...
            <div class="mt-6 lg:mt-0">
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
                    <div class="text-center">
                        ...
                        <div class="text-sm text-gray-500 dark:text-gray-400">Ежедневные доходы</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-gradient-to-r from-orange-50 to-yellow-50 dark:from-gray-800 dark:to-gray-700 rounded-xl p-6 mb-8 border border-orange-100 dark:border-gray-600">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="text-center">
                ...
                <div class="text-sm text-gray-600 dark:text-gray-300">Общая рыночная капитализация</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">24/7</div>
                <div class="text-sm text-gray-600 dark:text-gray-300">Часы торговли</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-purple-600 dark:text-purple-400">10K+</div>
                <div class="text-sm text-gray-600 dark:text-gray-300">Активные монеты</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">100M+</div>
                <div class="text-sm text-gray-600 dark:text-gray-300">Пользователи по всему миру</div>
            </div>
        </div>
    </div>
    ...
    <div x-data="{ selectedPlan: null }" class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 mb-12">
                ...
                <div class="relative h-48 bg-gradient-to-br from-orange-400 via-yellow-500 to-red-500 overflow-hidden">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="text-center text-white">
                            ...
                            <div class="text-sm font-medium opacity-90">Инвестиции в криптовалюту</div>
                        </div>
                    </div>
                    <!-- Floating ROI -->
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <div class="text-right">
                                <div class="text-sm text-gray-500 dark:text-gray-400">Продолжительность</div>
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <div class="flex items-center justify-between py-2 px-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Общий ожидаемый доход</span>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-3 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                                    <div class="flex justify-between items-center text-sm">
                                        <span class="text-gray-600 dark:text-gray-400">{{$plan->increment_interval}} доход:</span>
                                        <span class="font-medium text-orange-600 dark:text-orange-400">
                                            {{Auth::user()->currency}}<span x-text="(amount * {{$plan->increment_amount}} / 100).toFixed(2)"></span>
                                        </span>
                                    </div>
                                    <div class="flex justify-between items-center text-sm mt-1">
                                        <span class="text-gray-600 dark:text-gray-400">Общий доход ({{$plan->expiration}} дней):</span>
        ...
        @empty
            ...
            <div class="col-span-full flex flex-col items-center justify-center p-12 bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700">
                ...
                <h3 class="text-2xl font-bold text-gray-800 dark:text-white mb-2">Криптопланы недоступны</h3>
                <p class="text-gray-600 dark:text-gray-400 text-center max-w-md mb-6">
                    Планы инвестиций в криптовалюту в настоящее время обновляются. Пожалуйста, проверьте позже для новых возможностей криптоинвестиций.
                </p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 mb-8 border border-gray-100 dark:border-gray-700">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
            ...
            Почему выбрать инвестиции в криптовалюту?
        </h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="flex space-x-4 p-4 bg-orange-50 dark:bg-orange-900/20 rounded-xl">
                ...
                <div>
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-1">Высокий потенциал роста</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">Криптовалюта предлагает исключительные возможности роста с потенциалом значительных доходов.</p>
                </div>
            </div>
            ...
            <div class="flex space-x-4 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl">
                ...
                <div>
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-1">Торговля 24/7</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">В отличие от традиционных рынков, криптовалютные рынки никогда не закрываются, предоставляя непрерывные возможности для торговли.</p>
                </div>
            </div>
            ...
            <div class="flex space-x-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
                ...
                <div>
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-1">Глобальный доступ</h4>
                    <p class="text-gray-600 dark:text-gray-400 text-sm">Доступ к мировым криптовалютным рынкам без географических ограничений или ограничений традиционного банкинга.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-xl p-8 mb-8 border border-gray-200 dark:border-gray-600">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">Наш криптовалютный портфель</h3>
    ...
    <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-6">
        <div class="flex">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium text-yellow-800 dark:text-yellow-200">Важное уведомление о рисках</h3>
                <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                    <p>Инвестиции в криптовалюту очень волатильны и несут значительный риск. Цены могут резко колебаться в короткие периоды. Инвестируйте только то, что можете позволить себе потерять. Прошлые результаты не гарантируют будущих результатов.</p>
                </div>
            </div>
        </div>
    </div>
