            ...
            <div class="page-inner">
                <div class="mt-2 mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="title1 ">Пополнить кошелек</h1>
                        </div>
                        <div>
                                ...
                                @if (!$toPay)
                                    <div class="col-md-8 offset-md-2">
                                        <form wire:submit.prevent='setToPay'>
                                            ...
                                            <div class="my-2">
                                                <label for="" class="mb-2">Способ оплаты</label>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary">Перейти к
                                                    оплате</button>
                                            </div>
                                        </form>
                                    </div>
                                ...
                                @if ($toPay)
                                    <div class="col-12 text-right">
                                        <button type="button" class="btn btn-sm btn-warning"
                                            wire:click='unSetToPay'>назад</button>
                                    </div>
                                    <div class="col-md-8 offset-md-2 mt-3">
                                        <form action="" wire:submit.prevent='completePayment'>
                                            <div class="form-group p-2 bg-light">
                                                <p>
                                                    Пожалуйста, отправьте ${{ $amount }} {{ $method }} на
                                                    кошелек ниже
                                                </p>
                                                <h2 class=" font-weight-bold">{{ $walletAddress }}</h2>
                                            </div>
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary">Завершить оплату</button>
                                            </div>
                                        </form>
                                    </div>
                                @endif
