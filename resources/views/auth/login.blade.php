                ...
                <div class="relative">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-300 text-sm sm:text-base">
                            Получите доступ к вашей торговой панели
                        </p>
                        ...
                        <div class="flex items-center justify-center gap-6 mt-6 text-xs sm:text-sm">
                            <div class="text-center">
                                ...
                                <div class="text-gray-400">Рынки 24/7</div>
                            </div>
                            <div class="w-px h-10 bg-white/20"></div>
                            <div class="text-center">
                                <div class="flex items-center justify-center gap-1 text-blue-400 mb-1">
                                    <i data-lucide="zap" class="w-3 h-3"></i>
                                    <span class="font-medium">Быстрое</span>
                                </div>
                                <div class="text-gray-400">Исполнение</div>
                            </div>
                            <div class="w-px h-10 bg-white/20"></div>
                            <div class="text-center">
                                <div class="flex items-center justify-center gap-1 text-cyan-400 mb-1">
                                    <i data-lucide="shield" class="w-3 h-3"></i>
                                    <span class="font-medium">Безопасная</span>
                                </div>
                                <div class="text-gray-400">Платформа</div>
                            </div>
                        </div>
                    </div>
                    <!-- Error Messages -->
                    ...
                    <form action="{{ route('login') }}" method="post" class="space-y-6">
                        ...
                        <div class="mt-8">
                            <button type="submit"
                                ...
                                <span>Получить доступ к панели</span>
                    ...
                    <div class="mt-8">
                        <div class="relative">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="bg-gray-900 px-4 text-gray-300 font-medium">Быстрый доступ</span>
                            </div>
                        </div>
                    ...
                    <div class="mt-10 text-center space-y-6">
                        <!-- Register Link -->
                        <div class="text-sm">
                            <span class="text-gray-300">Новые в трейдинге? </span>
