                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="investment_type" required>
                                            ...
                                            <option value="stock" {{ (isset($plan->investment_type) && $plan->investment_type == 'stock') ? 'selected' : '' }}>Stock</option>
                                            <option value="crypto" {{ (isset($plan->investment_type) && $plan->investment_type == 'crypto') ? 'selected' : '' }}>Crypto</option>
                                            <option value="real_estate" {{ (isset($plan->investment_type) && $plan->investment_type == 'real_estate') ? 'selected' : '' }}>Real Estate</option>
                                        </select>
